...
type CarouselElementProps = React.ComponentProps<'div'> & CarouselProps
...
export function Content({ className, ...props }: CarouselContentProps) {
...
export function Item({ className, ...props }: CarouselItemProps) {
